...
[![Build Status](https://travis-ci.org/osmlab/atlas-checks.svg?branch=master)](https://travis-ci.org/osmlab/atlas-checks)  -- [Sonar](https://sonarcloud.io/dashboard?id=org.openstreetmap.atlas%3Aatlas-checks)
