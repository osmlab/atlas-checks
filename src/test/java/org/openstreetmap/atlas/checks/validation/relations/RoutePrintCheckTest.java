 ...
 * @author Lluc
 */
public class RoutePrintCheckTest {

    private static final RoutePrintCheck check = new RoutePrintCheck(
            ConfigurationResolver.emptyConfiguration());
    @Rule
    public RoutePrintCheckTestRule setup = new RoutePrintCheckTestRule();
    @Rule
