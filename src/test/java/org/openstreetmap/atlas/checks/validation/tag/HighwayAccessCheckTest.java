...
public class HighwayAccessCheckTest
{
    ...
    private final HighwayAccessCheck check = new HighwayAccessCheck(
            ConfigurationResolver.emptyConfiguration());

    @Test
    public void falsePositiveAccessTagIsPermissiveHighwayTagIsWrong()
    {
        this.verifier.actual(this.setup.falsePositiveAccessTagIsPermissiveHighwayTagIsWrong(),
                this.check);
    ...
    {
        this.verifier.actual(this.setup.falsePositiveAccessTagIsWrongHighwayTagIsCorrect(),
                this.check);
        this.verifier.verifyEmpty();
    }
    ...
    {
        this.verifier.actual(this.setup.falsePositiveAccessTagIsWrongHighwayTagIsWrong(),
                this.check);
        this.verifier.verifyEmpty();
    }
    ...
    {
        this.verifier.actual(this.setup.truePositiveAccessTagIsPermissiveHighwayTagIsBridleway(),
                this.check);
    ...
    {
        this.verifier.actual(this.setup.truePositiveAccessTagIsPermissiveHighwayTagIsBusguideway(),
                this.check);
        this.verifier.verifyExpectedSize(1);
    }
    ...
    {
        this.verifier.actual(this.setup.truePositiveAccessTagIsPermissiveHighwayTagIsBusway(),
                this.check);
        this.verifier.verifyExpectedSize(1);
    }
    ...
    {
        this.verifier.actual(this.setup.truePositiveAccessTagIsPermissiveHighwayTagIsCycleway(),
                this.check);
        this.verifier.verifyExpectedSize(1);
    }
    ...
    {
        this.verifier.actual(this.setup.truePositiveAccessTagIsPermissiveHighwayTagIsFootway(),
                this.check);
        this.verifier.verifyExpectedSize(1);
    }
    ...
    {
        this.verifier.actual(this.setup.truePositiveAccessTagIsPermissiveHighwayTagIsMotorway(),
                this.check);
        this.verifier.verifyExpectedSize(1);
    }
    ...
    {
        this.verifier.actual(this.setup.truePositiveAccessTagIsPermissiveHighwayTagIsPath(),
                this.check);
        this.verifier.verifyExpectedSize(1);
    }
    ...
    {
        this.verifier.actual(this.setup.truePositiveAccessTagIsPermissiveHighwayTagIsPedestrian(),
                this.check);
        this.verifier.verifyExpectedSize(1);
    }
    ...
    {
        this.verifier.actual(this.setup.truePositiveAccessTagIsPermissiveHighwayTagIsRaceway(),
                this.check);
        this.verifier.verifyExpectedSize(1);
    }
    ...
    {
        this.verifier.actual(this.setup.truePositiveAccessTagIsPermissiveHighwayTagIsSteps(),
                this.check);
        this.verifier.verifyExpectedSize(1);
    }
    ...
    {
        this.verifier.actual(this.setup.truePositiveAccessTagIsPermissiveHighwayTagIsTrack(),
                this.check);
        this.verifier.verifyExpectedSize(1);
    }
    ...
    {
        this.verifier.actual(this.setup.truePositiveAccessTagIsPermissiveHighwayTagIsTrunk(),
                this.check);
        this.verifier.verifyExpectedSize(1);
    }
    ...
    {
        this.verifier.actual(this.setup.truePositiveAccessTagIsYesHighwayTagIsBridleway(),
                this.check);
        this.verifier.verifyExpectedSize(1);
    }
    ...
    {
        this.verifier.actual(this.setup.truePositiveAccessTagIsYesHighwayTagIsBusguideway(),
                this.check);
        this.verifier.verifyExpectedSize(1);
    }
    ...
    {
        this.verifier.actual(this.setup.truePositiveAccessTagIsYesHighwayTagIsCycleway(),
                this.check);
        this.verifier.verifyExpectedSize(1);
    }
    ...
    {
        this.verifier.actual(this.setup.truePositiveAccessTagIsYesHighwayTagIsFootway(),
                this.check);
        this.verifier.verifyExpectedSize(1);
    }
    ...
    {
        this.verifier.actual(this.setup.truePositiveAccessTagIsYesHighwayTagIsMotorway(),
                this.check);
        this.verifier.verifyExpectedSize(1);
    }
    ...
    {
        this.verifier.actual(this.setup.truePositiveAccessTagIsYesHighwayTagIsPedestrian(),
                this.check);
        this.verifier.verifyExpectedSize(1);
    }
    ...
    {
        this.verifier.actual(this.setup.truePositiveAccessTagIsYesHighwayTagIsRaceway(),
                this.check);
        this.verifier.verifyExpectedSize(1);
    }
