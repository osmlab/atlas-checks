...
public class TollValidationCheckTestRule extends CoreTestRule
{
    ...
    @TestAtlas(nodes = { @Node(coordinates = @Loc(value = WAY4_NODE1)),
            ...
            @Node(coordinates = @Loc(value = WAY5_NODE2)) }, edges = {
                    @Edge(id = "6000001", coordinates = {
                            @Loc(value = WAY4_NODE1),
                            @Loc(value = WAY1_NODE1) }, tags = { "highway=motorway",
                                    "toll=no" }),
                    @Edge(id = "7000001", coordinates = {
                            @Loc(value = WAY1_NODE1),
                            @Loc(value = WAY1_NODE2) }, tags = { "highway=motorway",
                                    "toll=yes" }),
                    @Edge(id = "8000001", coordinates = {
                            @Loc(value = WAY1_NODE2),
                            @Loc(value = WAY2_NODE2) }, tags = { "highway=motorway",
                                    "toll=yes" }),
                    @Edge(id = "9000001", coordinates = {
                            @Loc(value = WAY2_NODE2),
                            @Loc(value = WAY5_NODE2) }, tags = { "highway=motorway",
                                    "toll=no" }) })
    ...
    @TestAtlas(nodes = { @Node(coordinates = @Loc(value = WAY1_NODE1)),
            ...
            @Node(coordinates = @Loc(value = WAY3_NODE2)) }, edges = {
                    @Edge(id = "3000001", coordinates = {
                            @Loc(value = WAY1_NODE1),
                            @Loc(value = WAY1_NODE2) }, tags = { "highway=motorway",
                                    "toll=yes" }),
                    @Edge(id = "4000001", coordinates = {
                            @Loc(value = WAY1_NODE2),
                            @Loc(value = WAY2_NODE2) }, tags = "highway=motorway"),
                    @Edge(id = "5000001", coordinates = {
                            @Loc(value = WAY2_NODE2),
    ...
    @TestAtlas(nodes = { @Node(coordinates = @Loc(value = WAY1_NODE1)),
            ...
            @Node(coordinates = @Loc(value = AREA_NODE4))}, edges = {
                    @Edge(id = "1000001", coordinates = {
                            @Loc(value = WAY1_NODE1),
                            @Loc(value = WAY1_NODE2) }, tags = "highway=motorway") }, areas = {
                                    @Area(coordinates = {
                                            @Loc(value = AREA_NODE1),
                                            @Loc(value = AREA_NODE2),
                                            @Loc(value = AREA_NODE3),
                                            @Loc(value = AREA_NODE4)}, tags = {"building=yes", "barrier=toll_booth"}) })
