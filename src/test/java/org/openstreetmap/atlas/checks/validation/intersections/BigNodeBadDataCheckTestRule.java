 ...
 **/
public class BigNodeBadDataCheckTestRule extends CoreTestRule
{
    /**
    ...
    @TestAtlas(loadFromTextResource = "MEX_7-24-55-subatlas.txt")
    private Atlas bigNodeAtlas;
    ...
    public Atlas getBigNodeAtlas()
    {
        return this.bigNodeAtlas;
    }
}
