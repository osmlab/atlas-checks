...
public class StreetNameCheckTestRule extends CoreTestRule{
    ...
    @TestAtlas(nodes = { @Node(id = "100001", coordinates = @Loc(value = WAY1_NODE1)),
            @Node(id = "100002", coordinates = @Loc(value = WAY1_NODE2),
                    tags = {"iso_country_code=AUT", "name=Peter-Strasser-Platz" }) }, edges = {
    ...
    @TestAtlas(nodes = { @Node(id = "200001", coordinates = @Loc(value = WAY1_NODE1)),
            ...
            @Edge(id = "200003", coordinates = { @Loc(value = WAY1_NODE1),
                    @Loc(value = WAY1_NODE2)
            })}, relations = {@Relation(id = "200004",
                    members={@Member(id="200002", type="node", role="any"),
                    @Member(id="200003", type="edge", role="any")},
                    tags = {"iso_country_code=AUT", "type=associatedStreet" }) })
    ...
    @TestAtlas(nodes = { @Node(id = "300001", coordinates = @Loc(value = WAY1_NODE1)),
            ...
            @Relation(id="300004", members = {
                    ...
                    @Member(id = "300003", type="edge", role="any")
            }, tags = {"iso_country_code=AUT", "name=Peter-Strasser-Platz"}) })
    ...
    @TestAtlas(nodes = { @Node(id = "500001", coordinates = @Loc(value = WAY1_NODE1)),
            @Node(id = "500002", coordinates = @Loc(value = WAY1_NODE2),
                    tags = {"iso_country_code=CHE", "name=Hauptstrasse" }) }, edges = {
    ...
    @TestAtlas(nodes = { @Node(id = "600001", coordinates = @Loc(value = WAY1_NODE1)),
            ...
            @Relation(id = "600004", members = {
                    ...
                    @Member(id = "600002", type="node", role="any")
            }, tags = {"iso_country_code=CHE", "type=associatedStreet"}) })
    ...
    @TestAtlas(nodes = { @Node(id = "700001", coordinates = @Loc(value = WAY1_NODE1)),
            ...
            @Relation(id = "700004", members = {
                    ...
                    @Member(id = "700002", type="node", role="any")
            }, tags = {"iso_country_code=CHE", "name=Hauptstrasse"}) })
    ...
    @TestAtlas(nodes = { @Node(id = "900001", coordinates = @Loc(value = WAY1_NODE1)),
            @Node(id = "900002", coordinates = @Loc(value = WAY1_NODE2),
                    tags = {"iso_country_code=DEU", "name=Peter-Strasser-Platz" }) }, edges = {
    ...
    @TestAtlas(nodes = { @Node(id = "1000001", coordinates = @Loc(value = WAY1_NODE1)),
            ...
            @Relation(id="1000004", members = {
                    ...
                    @Member(id = "1000002", type="node", role="any")
            }, tags = {"iso_country_code=DEU", "type=associatedStreet"}) })
    ...
    @TestAtlas(nodes = { @Node(id = "1100001", coordinates = @Loc(value = WAY1_NODE1)),
            ...
            @Relation(id="1100004", members = {
                    ...
                    @Member(id = "1100002", type="node", role="any")
            }, tags = {"iso_country_code=DEU", "name=Peter-Strasser-Platz" }) })
    ...
    @TestAtlas(nodes = { @Node(id = "1300001", coordinates = @Loc(value = WAY1_NODE1)),
            @Node(id = "1300002", coordinates = @Loc(value = WAY1_NODE2),
                    tags = {"iso_country_code=LIE", "name=Hauptstrasse" }) }, edges = {
    ...
    @TestAtlas(nodes = { @Node(id = "1400001", coordinates = @Loc(value = WAY1_NODE1)),
            ...
            @Relation(id = "1400004", members = {
                    ...
                    @Member(id = "1400002", type="node", role="any")
            }, tags = {"iso_country_code=LIE", "type=associatedStreet"}) })
    ...
    @TestAtlas(nodes = { @Node(id = "1500001", coordinates = @Loc(value = WAY1_NODE1)),
            ...
            @Relation(id = "1500004", members = {
                    ...
                    @Member(id = "1500002", type="node", role="any")
            }, tags = {"iso_country_code=LIE", "name=Hauptstrasse"}) })
    ...
    @TestAtlas(nodes = { @Node(id = "1700001", coordinates = @Loc(value = WAY1_NODE1)),
            @Node(id = "1700002", coordinates = @Loc(value = WAY1_NODE2),
                    tags = {"iso_country_code=AUT", "name=Hauptstrasse" }) }, edges = {
    ...
    @TestAtlas(nodes = { @Node(id = "1800001", coordinates = @Loc(value = WAY1_NODE1)),
            ...
            @Relation(id = "1800004", members = {
                    ...
                    @Member(id = "1800002", type="node", role="any")
            }, tags = {"iso_country_code=AUT", "name=Hauptstrasse" }) })
    ...
    @TestAtlas(nodes = { @Node(id = "2000001", coordinates = @Loc(value = WAY1_NODE1)),
            @Node(id = "2000002", coordinates = @Loc(value = WAY1_NODE2),
                    tags = {"iso_country_code=CHE", "name=Hauptstra\u00dfe" }) }, edges = {
            @Edge(id = "2000003", coordinates = { @Loc(value = WAY1_NODE1),
                    @Loc(value = WAY1_NODE2) }) })
    ...
    @TestAtlas(nodes = { @Node(id = "2100001", coordinates = @Loc(value = WAY1_NODE1)),
            ...
            @Relation(id = "2100004", members = {
                    ...
                    @Member(id = "2100002", type="node", role="any")
            }, tags = {"iso_country_code=CHE", "name=Hauptstra\u00dfe" }) })
    ...
    @TestAtlas(nodes = { @Node(id = "2300001", coordinates = @Loc(value = WAY1_NODE1)),
            @Node(id = "2300002", coordinates = @Loc(value = WAY1_NODE2),
                    tags = {"iso_country_code=DEU", "name=Hauptstrasse" }) }, edges = {
    ...
    @TestAtlas(nodes = { @Node(id = "2400001", coordinates = @Loc(value = WAY1_NODE1)),
            ...
            @Relation(id = "2400004", members = {
                    ...
                    @Member(id = "2400002", type="node", role="any")
            }, tags = {"iso_country_code=DEU", "type=associatedStreet" }) })
    ...
    @TestAtlas(nodes = { @Node(id = "2500001", coordinates = @Loc(value = WAY1_NODE1)),
            ...
            @Relation(id = "2500004", members = {
                    ...
                    @Member(id = "2500002", type="node", role="any")
            }, tags = {"iso_country_code=DEU", "name=Hauptstrasse" }) })
    ...
    @TestAtlas(nodes = { @Node(id = "2700001", coordinates = @Loc(value = WAY1_NODE1)),
            @Node(id = "2700002", coordinates = @Loc(value = WAY1_NODE2),
                    tags = {"iso_country_code=LIE", "name=Hauptstra\u00dfe" }) }, edges = {
    ...
    @TestAtlas(nodes = { @Node(id = "2800001", coordinates = @Loc(value = WAY1_NODE1)),
            ...
            @Relation(id = "2800004", members = {
                    ...
                    @Member(id = "2800002", type="node", role="any")
            }, tags = {"iso_country_code=LIE", "name=Hauptstra\u00dfe" })})
    ...
    public Atlas falsePositiveAutNodeInvalidValue() {return this.falsePositiveAutNodeInvalidValue;}

    public Atlas falsePositiveAutRelationDeprecatedTag() {return this.falsePositiveAutRelationDeprecatedTag;}

    public Atlas falsePositiveAutRelationInvalidValue(){return this.falsePositiveAutRelationInvalidValue;}

    public Atlas falsePositiveAutWayInvalidTag() {return this.falsePositiveAutWayInvalidValue;}

    public Atlas falsePositiveCheNodeInvalidValue() {return this.falsePositiveCheNodeInvalidValue;}

    public Atlas falsePositiveCheRelationDeprecatedTag() {return this.falsePositiveCheRelationDeprecatedTag;}

    public Atlas falsePositiveCheRelationInvalidValue() {return this.falsePositiveCheRelationInvalidValue;}

    public Atlas falsePositiveCheWayInvalidValue() {return this.falsePositiveCheWayInvalidValue;}

    public Atlas falsePositiveDeuNodeInvalidValue() {return this.falsePositiveDeuNodeInvalidValue;}

    public Atlas falsePositiveDeuRelationDeprecatedTag() {return this.falsePositiveDeuNodeInvalidValue;}

    public Atlas falsePositiveDeuRelationInvalidValue() {return this.falsePositiveDeuRelationInvalidValue;}

    public Atlas falsePositiveDeuWayInvalidValue() {return this.falsePositiveDeuWayInvalidValue;}

    public Atlas falsePositiveLieNodeInvalidValue() {return this.falsePositiveLieNodeInvalidValue;}

    public Atlas falsePositiveLieRelationDeprecatedTag() {return this.falsePositiveLieRelationDeprecatedTag;}

    public Atlas falsePositiveLieRelationInvalidValue() {return this.falsePositiveLieRelationInvalidValue;}

    public Atlas falsePositiveLieWayInvalidValue() {return this.falsePositiveLieWayInvalidValue;}

    public Atlas truePositiveAutNodeInvalidValue() {return this.truePositiveAutNodeInvalidValue;}

    public Atlas truePositiveAutRelationInvalidValue() {return this.truePositiveAutRelationInvalidValue;}

    public Atlas truePositiveAutWayInvalidValue() {return this.truePositiveAutWayInvalidValue;}

    public Atlas truePositiveCheNodeInvalidValue() {return this.truePositiveCheNodeInvalidValue;}

    public Atlas truePositiveCheRelationInvalidValue() {return this.truePositiveCheRelationInvalidValue;}

    public Atlas truePositiveCheWayInvalidValue() {return this.truePositiveCheWayInvalidValue;}

    public Atlas truePositiveDeuNodeInvalidValue() {return this.truePositiveDeuNodeInvalidValue;}

    public Atlas truePositiveDeuRelationDeprecatedTag() {return this.truePositiveDeuRelationDeprecatedTag;}

    public Atlas truePositiveDeuRelationInvalidValue() {return this.truePositiveDeuRelationInvalidValue;}

    public Atlas truePositiveDeuWayInvalidValue() {return this.truePositiveDeuWayInvalidValue;}

    public Atlas truePositiveLieNodeInvalidValue() {return this.truePositiveLieNodeInvalidValue;}

    public Atlas truePositiveLieRelationInvalidValue() {return this.truePositiveLieRelationInvalidValue;}

    public Atlas truePositiveLieWayInvalidValue() {return this.truePositiveLieWayInvalidValue;}
}
