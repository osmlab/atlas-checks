...
public class RouteRelationCheckTestRule extends CoreTestRule
{
    ...
    // Valid
    @TestAtlas(nodes = {
            @Node(coordinates = @Loc(value = Edge1StartLOCATION), id = Edge1StartLOCATION_ID),
                            ...
                            @Edge(coordinates = { @Loc(value = Edge4StartLOCATION),
                                    @Loc(value = Edge4EndLOCATION) }, id = Edge4ID) }, relations = @Relation(members = {
                                            ...
                                            @Member(id = STOP1ID, role = "stop", type = "POINT") }, id = RELATION2ID, tags = {
                                                    "type=route", "route=bus", "network=lcn",
                                                    "operator=Valley Flyer", "ref=110",
                                                    "colour=#A10082" }))
    ...
    @TestAtlas(nodes = {
            @Node(coordinates = @Loc(value = Edge3StartLOCATION), id = Edge3StartLOCATION_ID),
            @Node(coordinates = @Loc(value = Edge3EndLOCATION), id = Edge3EndLOCATION_ID),
                                                    ...
                                                    @Loc(value = Line6EndLOCATION) }, tags = {
                                                            "natural=coastline" }) }, relations = {
                                                                    ...
                                                                    @Relation(members = {
                                                                            ...
                                                                            @Member(id = RELATION6ID, role = "", type = "RELATION") }, id = RELATIONROUTEMASTER1ID, tags = {
                                                                                    "type=route_master",
                                                                                    "route_master=bus",
                                                                                    "network=lcn",
                                                                                    "operator=Valley Flyer",
                                                    ...
                                                    @Loc(value = Line6EndLOCATION) }, tags = {
                                                            "natural=coastline" }) }, relations = {
                                                                    ...
                                                                    @Relation(members = {
                                                                            ...
                                                                            @Member(id = PLATFORM1ID, role = "platform", type = "POINT") }, id = RELATIONROUTEMASTER1ID, tags = {
                                                                                    "type=route_master",
                                                                                    "route_master=bus",
                                                                                    "network=Metlink",
                                                                                    "operator=Valley Flyer",
