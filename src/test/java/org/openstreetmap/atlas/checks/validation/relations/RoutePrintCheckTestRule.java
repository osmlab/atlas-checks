 ...
 * @author Lluc
 */
public class RoutePrintCheckTestRule extends CoreTestRule {
    ...
    private static final String SIGN1 = "-0.5424920790473705, 2.049958909453347";
    private static final String  SIGN1ID= "1001";
    ...
    @TestAtlas(nodes = {@Node(coordinates = @Loc(value = Edge1StartLOCATION), id = Edge1StartLOCATION_ID),
            ...
            @Point(coordinates = @Loc(value = SIGN1), id = SIGN1ID)}, edges = {
            ...
            @Member(id = SIGN1ID, role = "sign", type = "POINT")}, id = RELATION1ID, tags = {
            "type=route",
            "route=bicycle",
            "network=lcn",
    ...
    @TestAtlas(nodes = {@Node(coordinates = @Loc(value = Edge1StartLOCATION), id = Edge1StartLOCATION_ID),
            ...
            @Member(id = Edge3ID, role = "", type = "EDGE"),
            @Member(id = Edge4ID, role = "", type = "EDGE"),
            @Member(id = SIGN1ID, role = "sign", type = "POINT")}, id = RELATION2ID, tags = {
            "type=route",
            "route=bus",
            "network=lcn",
            "operator=Valley Flyer",
    ...
    @TestAtlas(nodes = {@Node(coordinates = @Loc(value = Edge3StartLOCATION), id = Edge3StartLOCATION_ID),
            ...
            @Member(id = SIGN1ID, role = "sign", type = "POINT")}, id = RELATION4ID, tags = {
            "type=route",
            "route=bus",
            "network=lcn",
            "operator=Valley Flyer",
    ...
    @TestAtlas(nodes = {@Node(coordinates = @Loc(value = Edge1StartLOCATION), id = Edge1StartLOCATION_ID),
            ...
            @Member(id = Edge3ID, role = "", type = "EDGE"),
            @Member(id = Line6ID, role = "", type = "lINE"),
            @Member(id = SIGN1ID, role = "sign", type = "POINT")}, id = RELATION5ID, tags = {
            "type=route",
            "route=foot",
            "network=lcn",
            "operator=Valley Flyer",
    ...
    @TestAtlas(nodes = {@Node(coordinates = @Loc(value = Edge1StartLOCATION), id = Edge1StartLOCATION_ID),
            ...
            points = {@Point(coordinates = @Loc(value = SIGN1), id = SIGN1ID),
    ...
    @TestAtlas(nodes = {@Node(coordinates = @Loc(value = Edge1StartLOCATION), id = Edge1StartLOCATION_ID),
            ...
            @Relation(members = {
                    @Member(id = RELATION1ID, role = "", type = "RELATION"),
                    @Member(id = RELATION2ID, role = "", type = "RELATION"),
                    @Member(id = SIGN1ID, role = "sign", type = "POINT"),
    ...
    @TestAtlas(nodes = {@Node(coordinates = @Loc(value = Edge1StartLOCATION), id = Edge1StartLOCATION_ID),
            ...
            @Relation(members = {
                    ...
                    @Member(id = RELATION2ID, role = "", type = "RELATION"),
                    @Member(id = Edge4ID, role = "", type = "EDGE"),
                    @Member(id = SIGN1ID, role = "sign", type = "POINT")}, id = RELATIONROUTEMASTER2ID, tags = {
                    "type=route_master",
                    "route_master=train",
                    "network=Metlink",
                    "operator=Valley Flyer",
