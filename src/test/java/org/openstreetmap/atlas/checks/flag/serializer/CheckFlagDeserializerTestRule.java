...
/**
 * Unit test rule for {@link CheckFlagDeserializerTest}.
 *
 * @author bbreithaupt
 */
public class CheckFlagDeserializerTestRule extends CoreTestRule
{
    ...
    @TestAtlas(
            ...
            nodes = { @Node(id = "1000000", coordinates = @Loc(value = TEST1)),
                    ...
                    @Node(id = "4000000", coordinates = @Loc(value = TEST4)) },
            // Edges
            edges = {
                    @Edge(id = "1000000", coordinates = { @Loc(value = TEST1), @Loc(value = TEST2),
                            @Loc(value = TEST3) }, tags = "highway=footway"),
                    @Edge(id = "2000000", coordinates = { @Loc(value = TEST3), @Loc(value = TEST4),
                            @Loc(value = TEST1) }, tags = "highway=footway"),
                    @Edge(id = "3000000", coordinates = { @Loc(value = TEST3), @Loc(value = TEST1),
                            @Loc(value = TEST4) }, tags = "highway=footway") },
            // Relations
