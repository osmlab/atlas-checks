            ...
            for rule in priority_string['rules']:
                if isinstance(rule, dict):
                    ...
                    if len(rule_elements) == 2:
                        ...
                        priority_rule = maproulette.PriorityRule(
                        ...
                        fixed_rules.append(priority_rule)
        return maproulette.PriorityRuleModel(condition=condition, rules=fixed_rules).to_json()
...
def construct_challenge(config_object, check_name, project_id):
    ...
    return maproulette.ChallengeModel(
        parent=project_id,
