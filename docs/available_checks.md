...
| [StreetNameCheck](checks/streetNameCheck.md) |This check looks for "ss" or "\u00df" in street_name or name tags in AUT, CHE, DEU and LIE. In addition, it flags the deprecated tags of type "associatedStreet" in DEU.
